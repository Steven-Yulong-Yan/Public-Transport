...
public class Network {
     ...
     * If any of the stops in the given list are null,
     * none of them should be added. If any of the stops in the given list
     * already exist in the network, a DuplicateStopException should be thrown
     *
     * @param stops The stops to add to the network.
     *
     * @throws DuplicateStopException If any of the stops already exist
     * in the network. If there are any duplicate stops,
     * none of the stops should be added (i.e. either all of the stops
    ...
    public void addStops(List<Stop> stops) throws DuplicateStopException {
        ...
        for (Stop stop : stops) {
            for (Stop existingStop : this.stops) {
                if (stop.equals(existingStop)) {
                    throw new DuplicateStopException();
                }
            }
        }
